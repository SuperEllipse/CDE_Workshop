...
predictions.write.format('parquet').mode("overwrite").saveAsTable('default.LC_model_scoring_vr3')

## Storing Model Pipeline to S3
pipelineModel.write().overwrite().save("s3a://go01-demo/datalake/cde-demo/pipeline/")
